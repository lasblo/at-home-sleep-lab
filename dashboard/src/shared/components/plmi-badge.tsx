...
const severityClasses: Record<string, string> = {
  normal:
    "bg-severity-normal/15 text-severity-normal border-severity-normal/25",
  ...
  severe:
    "bg-severity-severe/15 text-severity-severe border-severity-severe/25",
}
